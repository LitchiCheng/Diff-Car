...
//{
//    char dd[]= "ssssss";
//    esp8266_socket_connect(&esp0.device.sockets, (char*)"192.168.31.21", 777, AT_SOCKET_TCP, 1);
//    esp8266_socket_send(&esp0.device.sockets, dd, sizeof(dd), AT_SOCKET_TCP);
//    return 0;
//}
